...
printf ("\nTHE PLACE WHERE THE PRISONER WAS CONVICTED IS: %s",
					 a.convictedf);
...
printf ("\nTHE DATE PUNISHMENT STARTED AT IS: %s",
					 a.punishments);
...
printf ("\nEMERGENCY CONTACT'S PHONE NUMBER IS: %s",
					 a.emergencyn);
...
printf ("\nTHE PLACE WHERE THE PRISONER WAS CONVICTED: %s",
						 a.convictedf);
...
printf ("\nTHE DATE PUNISHMENT STARTED AT: %s",
						 a.punishments);
...
printf ("\nRELATION OF EMERGENCY CONTACT WITH PRISONER: %s",
						 a.emergencyr);
...
printf ("\nTHE DATE PUNISHMENT ENDS AT IS: %s",
						 a.punishmente);
				
printf ("\nPRISONER'S EMERGENCY CONTACT IS: %s",
						 a.emergencyc);
				
printf
				("\nRELATION OF EMERGENCY CONTACT WITH PRISONER IS: %s",
				 a.emergencyr);
